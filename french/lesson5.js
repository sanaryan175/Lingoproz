...
const questions = [
  ...
  { question: "Translate 'July' to French.", options: ["Juin", "Juillet", "Janvier", "Août"], answer: "Juillet", explanation: "'Juillet' is July in French." },
  { question: "What does 'Décembre' mean?", options: ["October", "November", "December", "January"], answer: "December", explanation: "'Décembre' means December in French." },
  { question: "Translate 'Spring' to French.", options: ["Été", "Printemps", "Automne", "Hiver"], answer: "Printemps", explanation: "'Printemps' is Spring in French." },
  ...
  { question: "Translate 'August' to French.", options: ["Août", "Octobre", "Avril", "Juin"], answer: "Août", explanation: "'Août' is August in French." },
  ...
  { question: "Translate 'January' to French.", options: ["Février", "Décembre", "Janvier", "Mars"], answer: "Janvier", explanation: "'Janvier' is January in French." },
  { question: "What is 'Été' in English?", options: ["Autumn", "Spring", "Summer", "Winter"], answer: "Summer", explanation: "'Été' means Summer in French." },
];
