...
const questions = [
  {
    question: "What is 'chanter' in English?",
    options: ["to dance", "to sing", "to run", "to write"],
    answer: "to sing",
    explanation: "'chanter' means 'to sing' in French."
  },
  {
    question: "Translate 'to eat' into French.",
    options: ["manger", "boire", "nager", "parler"],
    answer: "manger",
    explanation: "'manger' means 'to eat' in French."
  },
  {
    question: "What does 'écrire' mean?",
    options: ["to write", "to listen", "to walk", "to play"],
    answer: "to write",
    explanation: "'écrire' means 'to write' in French."
  },
  {
    question: "What is 'to travel' in French?",
    options: ["voyager", "regarder", "jouer", "marcher"],
    answer: "voyager",
    explanation: "'voyager' means 'to travel' in French."
  },
  {
    question: "Translate 'to listen' into French.",
    options: ["écouter", "chanter", "lire", "cuisiner"],
    answer: "écouter",
    explanation: "'écouter' means 'to listen' in French."
  },
  {
    question: "What does 'marcher' mean?",
    options: ["to walk", "to run", "to sleep", "to draw"],
    answer: "to walk",
    explanation: "'marcher' means 'to walk' in French."
  }
];
