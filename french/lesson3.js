document.addEventListener("DOMContentLoaded", function () {
 const questions = [
  {
    question: "What is the French word for 'Grandfather'?",
    options: ["Oncle", "Grand-père", "Neveu", "Père"],
    answer: "Grand-père",
    explanation: "'Grand-père' means Grandfather in French."
  },
  {
    question: "Which of these means 'Aunt' in French?",
    options: ["Tante", "Cousine", "Fille", "Maman"],
    answer: "Tante",
    explanation: "'Tante' is the French word for Aunt."
  },
  {
    question: "What does 'Cousin' mean in French?",
    options: ["Brother", "Nephew", "Cousin (male)", "Father"],
    answer: "Cousin (male)",
    explanation: "'Cousin' means a male cousin in French. The female version is 'Cousine'."
  },
  {
    question: "What is 'Fille' in English?",
    options: ["Daughter", "Mother", "Sister", "Aunt"],
    answer: "Daughter",
    explanation: "'Fille' means Daughter in French."
  },
  {
    question: "Translate 'Son' into French.",
    options: ["Fils", "Garçon", "Frère", "Mari"],
    answer: "Fils",
    explanation: "'Fils' is the French word for Son."
  },
  {
    question: "What does 'Neveu' mean?",
    options: ["Niece", "Nephew", "Grandson", "Cousin"],
    answer: "Nephew",
    explanation: "'Neveu' means Nephew in French."
  }
];
